...
**Contexto:** Vue 3 + TypeScript, design system em `frontend/src/assets/styles/variables.css`, componentes em `frontend/src/components/ui/` e `layout/`, views em `frontend/src/views/` e features em `frontend/src/features/`. Regras do agente frontend: `docs/agents/prompt-agente-frontend-studytrackpro.md`. Design: `docs/agents/prompt-agente-design-frontend-studytrackpro.md`.
...
- **Implementar tudo (alta):** "Implemente todas as melhorias de alta prioridade do documento docs/agents/prompt-implementar-melhorias-frontend.md."
- **Implementar um item:** "Implemente apenas o item 3 (WebSocket) do docs/agents/prompt-implementar-melhorias-frontend.md."
- **Implementar por tema:** "Implemente os itens de acessibilidade (2, 5 e 8) do docs/agents/prompt-implementar-melhorias-frontend.md."
