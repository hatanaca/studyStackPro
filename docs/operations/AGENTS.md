...
**Prompt completo:** `docs/agents/prompt-agente-frontend-studytrackpro.md`
...
**Prompt completo:** `docs/agents/prompt-agente-design-frontend-studytrackpro.md`
...
**Prompt completo:** `docs/agents/prompt-agente-backend-studytrackpro.md`

**Escopo do agente:**

- Laravel 11, PHP 8.2+, Sanctum 4, Reverb 1, Horizon 5, PostgreSQL 16 (schemas public + analytics), Redis 7, PHPUnit
- Melhorias, boas práticas, debug e implementação; consultor proativo (sugestões: Laravel Data, Pest, Laravel Actions, Enums, PHPStan, Telescope opcional em dev, etc.)
...
**Prompt completo:** `docs/agents/prompt-agente-fullstack-studytrackpro.md`
...
**Prompt completo:** `docs/agents/prompt-agente-integracao-debug-studytrackpro.md`
...
- Ferramentas por camada: PostgreSQL (EXPLAIN, triggers), Laravel (logs, `LogApiRequests`, Horizon, `queue:failed`; Telescope só se instalado em dev), Redis (MONITOR, tags), Reverb (channels, logs), Vue (DevTools, storeToRefs, Network/WS).
