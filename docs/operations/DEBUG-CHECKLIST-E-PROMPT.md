...
- **Agente de integração e debug:** regra em `.cursor/rules/integracao-debug-studytrackpro.mdc` e prompt em `docs/agents/prompt-agente-integracao-debug-studytrackpro.md`.
