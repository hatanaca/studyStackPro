...
- [ ] **Traits:** `HasUuid`, `HasAuditLog`, `HasApiResponse`, `HasCacheInvalidation` nos Models/Services.
- [ ] **Rate limiting:** Throttles nomeados (auth, search, sensitive, export, recalculate, health) em `routes/api.php` e `RouteServiceProvider`/config.
...
- [ ] **Checklists do projeto:** `docs/CHECKLIST-E-PROMPTS.md`, `frontend/docs/CHECKLIST-FRONTEND.md`; throttles em tabela.
- [ ] **Variáveis de ambiente:** `docs/ENV-VARS.md`, `.env.example` backend e frontend (API URL, Reverb, etc.).
...
- **Checklists oficiais:** `docs/CHECKLIST-E-PROMPTS.md`, `frontend/docs/CHECKLIST-FRONTEND.md`
- **Env:** `docs/ENV-VARS.md`, `backend/.env.example`, `frontend/.env.example`
