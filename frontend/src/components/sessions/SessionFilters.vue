...
import TechnologyPicker from '@/components/technologies/TechnologyPicker.vue'
  ...
  <div class="session-filters">
    <div class="session-filters__row">
      <div class="filter-group">
        ...
        <TechnologyPicker v-model="technology" placeholder="Todas" />
      </div>
      <div class="filter-group">
        <label>De</label>
      ...
      <div class="filter-group">
        ...
        <input v-model="minDuration" type="number" min="0" class="filter-input" placeholder="0" />
      </div>
      <div class="filter-group">
        <label>Mood (1-5)</label>
        <select v-model="mood" class="filter-input">
