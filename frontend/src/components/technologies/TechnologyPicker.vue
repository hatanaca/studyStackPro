...
const displayValue = computed(() => props.modelValue?.name ?? query.value)
...
<template>
  <div class="technology-picker">
    ...
    <div v-if="open && results.length" class="technology-picker__dropdown">
      <button
      ...
      <p v-if="loading" class="technology-picker__loading">Buscando...</p>
    </div>
  </div>
</template>
