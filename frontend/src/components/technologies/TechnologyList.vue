...
<template>
  <div class="technology-list">
    <div class="technology-list__header">
      <h2>Tecnologias</h2>
      <BaseButton v-if="!showForm" @click="openCreate">Nova tecnologia</BaseButton>
    </div>
    ...
    <div v-else-if="technologies.length" class="technology-list__grid">
      <TechnologyCard
    ...
    <p v-else class="empty">Nenhuma tecnologia cadastrada.</p>
  </div>
</template>
