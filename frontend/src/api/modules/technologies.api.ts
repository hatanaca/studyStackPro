...
export const technologiesApi = {
  ...
  getOne: (id: string) => apiClient.get<ApiResponse<Technology>>(ENDPOINTS.technologies.one(id)),
  ...
  delete: (id: string) => apiClient.delete<ApiResponse<null>>(ENDPOINTS.technologies.one(id)),
}
